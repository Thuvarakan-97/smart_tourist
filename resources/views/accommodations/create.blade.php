...
<head>
    ...
    <title>Add Accommodation - Smart Tourist</title>
    ...
    <div class="flex h-screen">
        ...
        <div class="w-64 bg-blue-800 text-white">
            ...
            <nav class="mt-8">
                ...
                <a href="{{ route('accommodations.create') }}" class="flex items-center px-4 py-3 bg-blue-700 text-white">
        ...
        <div class="flex-1 overflow-auto">
            <div class="p-6">
                <div class="max-w-2xl mx-auto">
                    <h2 class="text-2xl font-bold text-gray-800 mb-6">Add New Accommodation</h2>
                        ...
                        <form method="POST" action="{{ route('accommodations.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="md:col-span-2">
                                    <label for="title" class="block text-sm font-medium text-gray-700 mb-2">Accommodation Title</label>
                                ...
                                <div>
                                    ...
                                    <select name="dest_id" id="dest_id" required
                                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                        <option value="">Select Destination</option>
                                        @foreach($destinations as $destination)
                                            <option value="{{ $destination->id }}" {{ old('dest_id') == $destination->id ? 'selected' : '' }}>
                                                {{ $destination->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <!-- Price per Night -->
                                <div>
                                    <label for="price_per_night" class="block text-sm font-medium text-gray-700 mb-2">Price per Night (LKR)</label>
                                    <input type="number" name="price_per_night" id="price_per_night" value="{{ old('price_per_night') }}" step="0.01" required
                                           class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                ...
                                <!-- Image Upload -->
                                <div class="md:col-span-2">
                                    <label for="image" class="block text-sm font-medium text-gray-700 mb-2">Accommodation Image</label>
