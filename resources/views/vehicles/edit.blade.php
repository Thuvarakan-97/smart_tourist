...
<head>
    ...
    <title>Edit Vehicle - Smart Tourist</title>
        ...
        <div class="flex-1 overflow-auto">
            <div class="p-6">
                <div class="max-w-2xl mx-auto">
                    <h2 class="text-2xl font-bold text-gray-800 mb-6">Edit Vehicle</h2>
                    ...
                    <div class="bg-white rounded-lg shadow-md p-6">
                        <form method="POST" action="{{ route('vehicles.update', $vehicle) }}" enctype="multipart/form-data">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <select name="type" id="type" required
                                        ...
                                        <option value="tuk-tuk" {{ old('type', $vehicle->type) == 'tuk-tuk' ? 'selected' : '' }}>Tuk-Tuk</option>
                                    </select>
                                    @error('type')
                                ...
                                <div>
                                    ...
                                    <input type="number" name="price_per_day" id="price_per_day" value="{{ old('price_per_day', $vehicle->price_per_day) }}" step="0.01" required
                                           class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                    @error('price_per_day')
                                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                    @enderror
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea name="description" id="description" rows="3" required
                                              class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('description', $vehicle->description) }}</textarea>
                                    @error('description')
                                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="date" name="available_from" id="available_from" value="{{ old('available_from', $vehicle->available_from) }}" required
                                           class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                ...
                                <div>
                                    ...
                                    <input type="date" name="available_to" id="available_to" value="{{ old('available_to', $vehicle->available_to) }}" required
                                           class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                    @error('available_to')
                                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                    @enderror
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <div class="mb-4">
                                        <img src="{{ asset('storage/' . $vehicle->image_url) }}" alt="Current Vehicle Image" class="max-w-xs rounded-lg shadow-md">
                                    </div>
                                </div>
                                @endif
                                ...
                                <div class="md:col-span-2">
                                    <label for="image" class="block text-sm font-medium text-gray-700 mb-2">
                                        {{ $vehicle->image_url ? 'Update Vehicle Image' : 'Vehicle Image' }}
                                    </label>
                            ...
                            <div class="flex justify-end space-x-3 mt-6">
                                <a href="{{ route('vehicles.index') }}" class="px-4 py-2 text-gray-600 border border-gray-300 rounded-md hover:bg-gray-50">
                                    Cancel
                                </a>
